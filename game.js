...
function updateUI() {
    ...
    document.getElementById('upgrade-click').textContent = `+1 К КЛИКУ (${coinsPerClick * 100} монет)`;
    document.getElementById('upgrade-double').textContent = `ДАБЛ КЛИК (${multiplier * 10000} монет)`;
...
document.getElementById('upgrade-click').addEventListener('click', buyClickUpgrade);
document.getElementById('upgrade-double').addEventListener('click', buyDoubleUpgrade);
